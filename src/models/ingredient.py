...
print("Nome do ingrediente:", queijo_mussarela.name)
print("Restrições:", queijo_mussarela.restrictions)

teste = Ingredient("teste")
print("Nome do ingrediente:", teste.name)
print("Restrições:", teste.restrictions)
 """
